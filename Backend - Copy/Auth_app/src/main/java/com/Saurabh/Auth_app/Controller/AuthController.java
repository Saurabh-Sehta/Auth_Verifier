...
import com.Saurabh.Auth_app.Service.AppUserDetailsService;
import com.Saurabh.Auth_app.Service.ProfileService;
import com.Saurabh.Auth_app.Util.JwtUtil;
import com.Saurabh.Auth_app.io.AuthRequest;
import com.Saurabh.Auth_app.io.AuthResponse;
import com.Saurabh.Auth_app.io.EmailVerifyRequest;
...
public class AuthController {
    ...
    public ResponseEntity<?> login(@RequestBody AuthRequest request){
        try{
            ...
            error.put("message", "Credentials are wrong!");
            ...
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(error + e.getMessage() + " " + e.getClass());
        }
    }
    ...
    public void verifyEmail(@RequestBody EmailVerifyRequest emailVerifyRequest){
        ...
        try{
            profileService.verifyOtp(emailVerifyRequest.getEmail(), emailVerifyRequest.getOtp());
        } catch (Exception e){
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, e.getMessage());
        }
    }
